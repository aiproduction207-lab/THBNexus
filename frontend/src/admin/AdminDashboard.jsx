  ...
  return (
    <div style={{ padding: 24, background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#fff", padding: 20, borderRadius: 12, marginBottom: 20 }}>
        <h2 style={{ marginTop: 0 }}>Credit User</h2>
          ...
          <tbody>
            {users.map((u) => (
              <tr key={u.id}>
                ...
                <td style={tdStyle}>
                  <button onClick={() => toggleBlockUser(u.email, u.is_blocked)} style={{ ...actionButton, background: u.is_blocked ? "#16a34a" : "#dc2626" }}>
      ...
      <div style={{ background: "#fff", padding: 20, borderRadius: 12 }}>
        <h2 style={{ marginTop: 0 }}>Trade Logs</h2>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "#e2e8f0" }}>
              <th style={thStyle}>Email</th>
